...
var members = [['Mia Boloix', 'Sophomore CS/Math double major; enjoys all things vegan &amp; is most definitely <i>#teamVim</i>.'], ['Camila Camacho', 'Camila is the vice chair of ACM and works for the Hopkins IT department on JaySquad.'], ['Coco Li', 'Coco is a junior studying cognitive science and computer science; can be easily made happy with food.'], ['Aubin Lohier', 'CS sophomore, from NYC (QUEENS); enjoys Java, coffee, and not burning his kitchen down when he cooks.'], ['Julia Oppenheim', 'Junior studying Computer Science and Cognitive Science; passionate about education and avoiding gluten.'], ['Andrew Rojas', 'Treasurer of ACM, apple eater, bad cook. <i>West coast === best coast</i>'], ['Sara Weill', 'Sara is a sophomore CS/CE double major interested in cybersecurity; enjoys volunteering locally with APO.'], ['Tony Yang', 'Junior studying CS with an interest in networks; involved in oSTEM and local volunteering; enjoys cooking and is willing to try any food at least once.'], ['Evonne Zhu', 'Evonne is a junior majoring in Computer Science with minors in Music and Film &amp; Media Studies.'], ['Aly Kruglak', ''], ['Hailey Lee', ''], ['Rena Liu', ''], ['Daya Lu', ''], ['Natalie Martinez', ''], ['Madhu Rajmohan', ''], ['Momo Steele', ''], ['Gayatri Susarla', ''], ['Sharmila Tamby', ''], ['Nancy Wang', ''], ['Kristin Yim', ''], ['Bill Watson and Bailey Parker', '"We\'re being shipped as a unit. An absolute unit."', "billbailey"]];
